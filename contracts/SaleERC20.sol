...
import "./sale/SaleERC20Base.sol";
import "./Freeport.sol";

contract SaleERC20 is SaleERC20Base {

  	function initialize(Freeport freeport) public initializer {
  	  __SaleERC20Base_init(freeport);
  	}
    ...
    public {
        ...
        freeport.currencyContract().transferFrom(payer, seller, totalCost);
        freeport.captureFeeERC20(seller, nftId, price, amount);
