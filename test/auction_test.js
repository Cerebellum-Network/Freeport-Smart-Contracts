...
contract("Auction", accounts => {
    ...
    let deploy = async (freeport) => {
        ...
        let withdraw = async (account) => {
            ...
            await freeport.transferFrom(freeport.address, account, CURRENCY, balance, "0x");
        };
    ...
    it("sells an NFT by auction", async () => {
        ...
        await checkBalances([
            [buyerBob, someMoney, 0, 0], // BuyerBob got back his 100 money.
            [buyerBill, someMoney - 110, 1], // BuyerBill put 110 money as deposit.
    ...
    it.skip("sells an NFT on secured auction accepting USDC", async () => {
        const auction = await AuctionERC20.deployed();
        const PERCENT = 100;
